...
/*
  This handles the segment fault in limited ways
*/
...
int main()
{
  ...
  // These are the checkers used to know if the tests passed
  ...
  // Creates a string set
   ...
   int thirdElCounter = 0; // used to test = operator later
   ...
   */
   ...
   // used to test first constructor
   cout<<"\nThese are the elements of the set After Removing Chain:"<<endl;
   ...
   // used to test first constructor
   cout<<"\nThese are the elements of the set After Recreating Chain:"<<endl;
