...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// </summary>
        protected IEnumerable<String> GetCellsToRecalculate(ISet<String> names,ref bool cirChecker)
        {
            ...
            foreach (String name in names)
            {
                ...
                {
                    Visit(name, name, visited, changed, ref cirChecker);
                }
            }
            return changed;
        }
        ...
        /// </summary>
        protected IEnumerable<String> GetCellsToRecalculate(String name, ref bool cirChecker) // added variable
        {
            return GetCellsToRecalculate(new HashSet<String>() { name }, ref cirChecker);
        }
        ...
        /// </summary>
        private void Visit(String start, String name, ISet<String> visited, LinkedList<String> changed, ref bool cirChecker)
        {
            visited.Add(name);
            foreach (String n in GetDirectDependents(name))
            {
                if (n.Equals(start))
                {
                    ...
                    cirChecker = true; //  Circular exception exists
                }
                else if (!visited.Contains(n))
                {
                    Visit(start, n, visited, changed, ref cirChecker);
                }
            }
