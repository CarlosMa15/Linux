...
static int bmp_decode_flag = 0;

static int bmp_decode_frame(AVCodecContext *avctx,
                            void *data, int *got_frame,
                            AVPacket *avpkt)
{
  if(bmp_decode_flag == 0){
    av_log(NULL, AV_LOG_WARNING, "*** CS3505: Executing in bmp_decode_frame and bmp.c ***\n*** CS3505: Lukas Gust & Carlos Martinez ***\n");
